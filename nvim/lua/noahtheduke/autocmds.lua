...
local function set_ft(augroup, pattern, ft)
  if (nil == ft) then
    _G.error("Missing argument ft on fnl/noahtheduke/autocmds.fnl:3", 2)
  else
  end
  if (nil == pattern) then
    _G.error("Missing argument pattern on fnl/noahtheduke/autocmds.fnl:3", 2)
  else
  end
  if (nil == augroup) then
    _G.error("Missing argument augroup on fnl/noahtheduke/autocmds.fnl:3", 2)
  else
  end
