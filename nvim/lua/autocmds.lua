...
local function set_ft(augroup, pattern, ft)
  local function _1_(args)
    return vim.api.nvim_set_option_value("filetype", ft, {scope = "local"})
  end
...
do
  ...
  local function _2_(args)
    ...
    return vim.api.nvim_set_option_value("textwidth", 80, {scope = "local"})
  end
...
return vim.api.nvim_create_autocmd({"BufRead", "BufNewFile"}, {group = vim.api.nvim_create_augroup("HighlightFullWidthSpace", {}), pattern = "*", callback = _4_})
