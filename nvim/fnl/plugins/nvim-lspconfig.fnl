...
(fn get-client [name]
  (. (vim.lsp.get_clients {:name "clojure-lsp"}) 1))
...
(fn clojure-lsp []
  (vim.lsp.config :clojure-lsp clojure-lsp-config)
...
[(utils.dep
   ...
   {:dependencies ["https://github.com/johmsalas/text-case.nvim"]
    :config config})]
