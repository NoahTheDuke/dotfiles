...
"
" NoahTheDuke's additions
"
syn keyword clojureSpecial clojure.core/fn fn nextgroup=clojureFunction skipwhite
syn keyword clojureDefine clojure.core/defn clojure.core/defn- defn defn- nextgroup=clojureFunction skipwhite
syn match clojureFunction "\%(\%(defn\|defn-\|fn\)\s*\)\@<=\h\k\+" contained
